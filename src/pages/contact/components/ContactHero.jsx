          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-sm text-white/80">123 Education Blvd, Learning City, LC 12345</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 mt-8">
                ...
                <p className="text-sm text-white/80">Mon-Fri: 8AM-6PM<br />Sat: 9AM-4PM</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 -mt-4">
                ...
                <p className="text-sm text-white/80">admissions@eduvision.edu</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 mt-4">
